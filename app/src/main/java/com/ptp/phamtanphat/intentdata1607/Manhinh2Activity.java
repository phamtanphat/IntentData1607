...
//        }
//        Kieu 5 : ArrayList<Object>
        Intent intent = getIntent();
        if (intent.hasExtra("mangobject")){
            ArrayList<Nhanvien> mangnhanvien = intent.getParcelableArrayListExtra("mangobject");
            Log.d("BBB",mangnhanvien.size() + "" );
        }
    }
}
